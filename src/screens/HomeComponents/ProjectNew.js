...
import project2 from "../../Media/project11.png";
...
import project9 from "../../Media/project9.png";
import project10 from "../../Media/project10.png";


const images = [
  { id: 1, src: project1, title: 'Osira Network', link: 'https://osira.network/' },
  { id: 2, src: project2, title: 'Grass Solution', link: 'https://grras.com/' },
  { id: 3, src: project3, title: 'Daily Live Media', link: 'https://dailylivemedia.netlify.app/' },
   { id: 4, src: project9, title: 'Rent a Car', link: 'https://juberkb.github.io/rentacarwithme/' },
     { id: 5, src: project10, title: 'Next Anime', link: 'https://moviewithme.vercel.app/' },
  { id: 6, src: project4, title: 'Apple Web Clone', link: 'https://juberkb.github.io/apple-clone.in/' },
  { id: 7, src: project5, title: 'Tic Tac Toe Game', link: 'https://juberkb.github.io/tictactoe/'},
  { id: 9, src: project6, title: 'Live Clock', link: 'https://juberkb.github.io/realtimeclock/' },
  { id: 9, src: project7, title: 'Demo Project', link: 'https://juberkb.github.io/Project1.github.io/' },
  { id: 10, src: project8, title: 'First portfolio', link: 'https://juberkb.github.io/juberjkc/' },
   
      // { id: 11, src: project8, title: 'First portfolio', link: 'https://juberkb.github.io/juberjkc/' },
